...
-- It is seeded here so it always exists and can be locked (via a write to it) as the single serialization point for host registration and exclusive access
