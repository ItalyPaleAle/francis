...
- [**Scale horizontally**](https://francis.italypaleale.me/docs/topologies/) across many hosts without sharding your data by hand: Francis places each actor on exactly one host and routes calls to it
...
Create an actor host with an embedded SQLite store (the **local** topology, no extra services required), register your actor, and run it:
