...
# Builds every francis binary for a single release target, then packages them into an archive.
#
# Usage:
...
#
# Binaries are staged in .bin/francis-<BUILD_ID>-<target>, and the archive is written to .out
