...
func (_mock *MockClient[T]) DeleteJob(ctx context.Context, jobID string, opts ...actor.DeleteJobOption) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, ...actor.DeleteJobOption) error); ok {
		r0 = returnFunc(ctx, jobID, opts...)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
type MockClient_DeleteJob_Call[T any] struct {
	*mock.Call
}
...
func (_e *MockClient_Expecter[T]) DeleteJob(ctx any, jobID any, opts ...any) *MockClient_DeleteJob_Call[T] {
	return &MockClient_DeleteJob_Call[T]{Call: _e.mock.On("DeleteJob",
		append([]any{ctx, jobID}, opts...)...)}
}

func (_c *MockClient_DeleteJob_Call[T]) Run(run func(ctx context.Context, jobID string, opts ...actor.DeleteJobOption)) *MockClient_DeleteJob_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 []actor.DeleteJobOption
		variadicArgs := make([]actor.DeleteJobOption, len(args)-2)
...
func (_c *MockClient_DeleteJob_Call[T]) Return(err error) *MockClient_DeleteJob_Call[T] {
	_c.Call.Return(err)
	return _c
}

func (_c *MockClient_DeleteJob_Call[T]) RunAndReturn(run func(ctx context.Context, jobID string, opts ...actor.DeleteJobOption) error) *MockClient_DeleteJob_Call[T] {
	_c.Call.Return(run)
	return _c
}
...
type MockClient_Peek_Call[T any] struct {
	*mock.Call
}
...
//   - data any
//   - opts ...actor.InvokeOption
func (_e *MockClient_Expecter[T]) Peek(ctx any, actorType any, actorID any, method any, data any, opts ...any) *MockClient_Peek_Call[T] {
	return &MockClient_Peek_Call[T]{Call: _e.mock.On("Peek",
		append([]any{ctx, actorType, actorID, method, data}, opts...)...)}
}

func (_c *MockClient_Peek_Call[T]) Run(run func(ctx context.Context, actorType string, actorID string, method string, data any, opts ...actor.InvokeOption)) *MockClient_Peek_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockClient_Peek_Call[T]) Return(envelope actor.Envelope, err error) *MockClient_Peek_Call[T] {
	_c.Call.Return(envelope, err)
	return _c
}

func (_c *MockClient_Peek_Call[T]) RunAndReturn(run func(ctx context.Context, actorType string, actorID string, method string, data any, opts ...actor.InvokeOption) (actor.Envelope, error)) *MockClient_Peek_Call[T] {
	_c.Call.Return(run)
	return _c
}
