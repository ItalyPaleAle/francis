...
// Only francis-internal packages can supply it, since this package cannot be imported from outside the module, so it keeps the privileged paths private to the framework
type Key struct{}
